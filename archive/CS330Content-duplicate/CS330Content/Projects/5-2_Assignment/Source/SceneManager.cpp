...
void SceneManager::LoadSceneTextures()
{
	...
	// Load texture for the ground plane - using rustic wood texture
	bReturn = CreateGLTexture(
		"../../../Utilities/textures/rusticwood.jpg",
		"ground");

	// Load texture for the cone - using pavers/brick-like texture
	bReturn = CreateGLTexture(
		"../../../Utilities/textures/pavers.jpg",
		"cone_texture");

	// Load texture for the sphere - using stained glass texture for variety
	bReturn = CreateGLTexture(
		"../../../Utilities/textures/stainedglass.jpg",
		"sphere_texture");

	// Load texture for cylinder - using stainless steel texture
	bReturn = CreateGLTexture(
		"../../../Utilities/textures/stainless.jpg",
		"cylinder_texture");

	// Load texture for boxes - using drywall texture
	bReturn = CreateGLTexture(
...
void SceneManager::RenderScene()
{
	...
	// Apply texture to the ground plane
	...
	SetShaderTexture("cylinder_texture");
	...
	// Apply texture to the first box
	...
	// Apply texture to the second box
	SetShaderTexture("box_texture");
	SetTextureUVScale(1.0, 1.0);
	...
	// Apply texture to the sphere - one of the primary textured shapes
	SetShaderTexture("sphere_texture");
	SetTextureUVScale(1.0, 1.0);
	...
	// Apply texture to the cone - one of the primary textured shapes
	SetShaderTexture("cone_texture");
	SetTextureUVScale(1.0, 1.0);
