...
int main(int argc, char* argv[])
{
	...
	// load the shader code from the external GLSL files - EXACT COPY FROM 3-2
	...
	while (!glfwWindowShouldClose(g_Window))
	{
		...
		// Clear the frame and z buffers - EXACT COPY FROM 3-2 ASSIGNMENT
		glClearColor(0.4f, 0.5f, 0.7f, 1.0f);  // Blue-gray
