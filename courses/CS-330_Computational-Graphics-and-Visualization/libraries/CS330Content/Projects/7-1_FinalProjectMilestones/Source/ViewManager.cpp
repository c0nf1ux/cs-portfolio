...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	// send offsets to camera for orientation changes
...
{
	// adjust camera movement speed based on scroll wheel
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera left/right movement
	...
	// process camera up/down movement
